...
def create_account():
    ...
    # Si todo es correcto voy al Area de Contenido
...
def make_register_frame():
    global register_frame, name_entry, last_name_entry, age_entry, id_card_entry, password_entry
    # Creando el Frame
...
def on_log_out_button():
    global current_frame, start_frame, results_frame, content_frame
